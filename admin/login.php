        ...
        <div class="login-form style-2">
			<div class="tab-content">
                <div id="login" class="tab-pane active text-center">
                    <form class="p-a30 dez-form" method="post" action="aksi_login.php">
                        ...
                        <div class="form-group " >
                            <select name="area" id="" class="form-control " required>
                                ...
                                <option class="text-blue" value="SUMATERA BARAT">SUMATERA BARAT</option>
...
<!-- Mirrored from dexignzone.com/zone/EduZone/xhtml/login-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Aug 2017 04:58:16 GMT   CKEDITOR.replace( 'editor');-->
</html>
