              ...
              <div class="box-body">
                    ...
                    <div class="form-group">
                        <div class="col-sm-4 col-md-offset-2">
                            <button type="button" id="btn-tambah-form" class="form-control btn btn-primary"><i class="fa fa-plus"></i> Tambah Spesifikasi</button>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-4 col-md-offset-2">
                            <button type="button" id="btn-tambah-form2" class="form-control btn btn-info"><i class="fa fa-plus"></i> Tambah Foto</button>
                        </div>
                    </div>
            ...
            <form method="POST" class="user form-horizontal" action="" enctype="multipart/form-data">
              <div class="box-body">
                    ...
                    <hr><div class="form-group">
                        <label for="" class="col-sm-2 control-label">Harga Prioritas</label>
                        <div class="col-sm-4">
                       <input name="harga_p" type="number"  class="form-control" value="<?= $data['harga_prioritas'] ?>" required>
                        </div>
                        <label for="" class="col-sm-2 control-label"> Harga Reguler</label>
                        <div class="col-sm-4">
                    
                    <input name="harga_r" type="number"  class="form-control" value="<?= $data['harga_reguler']?>" required>
                        </div>
                    </div>
