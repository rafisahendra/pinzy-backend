...
<?php
  ...
  switch ($aksi){
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
      $save= mysqli_query($kon,"INSERT INTO `tb_sales`( `nama_sales`, `id_area`, `tgl_masuk`, `alamat`, `no_telepon`, `no_terdekat`, `plat_kendaraan`) VALUES ('$_POST[nama_sales]','$_POST[area]','$_POST[tgl_masuk]','$_POST[alamat]','$_POST[no_telepon]','$_POST[no_terdekat]','$_POST[plat_k]')");
            ...
            <form method="POST" class="user form-horizontal" action="" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input name="nama_sales" type="text"  class="form-control" placeholder="Nama Sales" required>
                        </div>
            ...
            <form method="POST" class="user form-horizontal" action="" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                        ...
                        <label for="" class="col-sm-2 control-label">Rekomendasi</label>
                        <div class="col-sm-4">
                            <select name="area_s" id="idarea_p" class="form-control">
                            <option value="">-- Silahkan Pilih Area --</option>
                                <?php
                                  $m = mysqli_query($kon, "SELECT * FROM tb_area");
                                  while($are = mysqli_fetch_assoc($m)){
                            ...
                            <script>
                              ...
                              document.getElementById("idarea_p").value = "<?= $id_area ?>";
              ...
              <div class="form-group" >
                      <div class="col-sm-2 text-left">
                      <button type="submit" name="save1"  class=" btn btn-primary btn-flat btn-block "> Ubah</button>
                      </div>
                      <div class="col-sm-2 text-right">
                      <a  href="index.php?module=sales/view" class=" btn btn-warning btn-flat btn-block "> Batal</a>
                      </div>
                    </div>
			      </div>
          </form>
